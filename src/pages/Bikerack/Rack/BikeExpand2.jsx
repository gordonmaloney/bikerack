...
const Points = [
  ...
  "M 0 1400 L 0 600 C 0 600 50 600 100 600 C 150 600 150 600 200 600 C 250 600 300 600 350 600 C 400 600 400 600 450 600 C 500 600 550 600 600 600 C 700 600 800 600 1400 600 L 1400 800 Z",
  "M 0 1400 L 0 350 C 101 328 90 561 140 425 C 172 329 224 576 284 552 C 350 522 358 345 400 350 C 472 357 384 499 500 500 C 750 500 551 299 600 250 C 679 177 680 416 1400 450 L 1400 800 Z",
...
"M 0 1400 L 0 -400 C 101 -400 90 -400 140 -400 C 172 -400 224 -400 284 -400 C 350 -400 358 -400 400 -400 C 472 -400 384 -400 500 -400 C 750 -400 551 -400 1400 -400 C 679 -400 680 -400 1400 -400 L 1400 800 Z",
...
export const BikeExpand = ({ bike, setExpand }) => {
  ...
  return (
    <div style={{ zIndex: 11, position: "fixed", width: "100vw", height: "100vh" }}>
      <svg
        id="morph"
        height="100%"
        width="100%"
